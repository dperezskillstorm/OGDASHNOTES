...
const { findAllRecords, createRecord, findAllRecordById, DeleteRecordById, updateRecord} = require('../controllers/GSSStats.controller');
const { updateMany, findByIdAndDelete } = require('../models/GSSStats.model');

//Created Labor Stats Records
