...
const { findAllRecords, createRecord, findAllRecordById, DeleteRecordById, updateRecord} = require('../controllers/LaborHours.controller');
const { updateMany, findByIdAndDelete } = require('../models/LaborHours.model');
