...
const { findAllRecords, createRecord, findAllRecordById, DeleteRecordById, updateRecord} = require('../controllers/Notes.controller');
const { updateMany, findByIdAndDelete } = require('../models/Notes.model');

//Created Notes Stats Records
