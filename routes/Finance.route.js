...
const { findAllRecords, createRecord, findAllRecordById, DeleteRecordById, updateRecord} = require('../controllers/Finance.controller');
const { updateMany, findByIdAndDelete } = require('../models/Finance.model');
